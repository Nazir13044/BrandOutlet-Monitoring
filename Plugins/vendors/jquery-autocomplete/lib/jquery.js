...
var expando = "jQuery" + now(), uuid = 0, windowData = {},
	...
	exclude = /z-?ImageUploader|font-?weight|opacity|zoom|line-?height/i,
	// cache defaultView
	...
	clean: function( elems, context ) {
		...
		jQuery.each(elems, function(i, elem){
			...
			if ( typeof elem == "string" ) {
				...
				// Trim whitespace, otherwise ImageUploaderOf won't work as expected
	...
	attr: function( elem, name, value ) {
		...
		if ( elem.tagName ) {
			...
			if ( name in elem && notxml && !special ) {
				...
				// browsers ImageUploader elements by id/name on forms, give priority to attributes.
